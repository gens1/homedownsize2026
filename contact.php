...
$e_body = "You have been contacted by $first_name. $first_name, their additional message is as follows." . PHP_EOL . PHP_EOL;
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	//echo 'ERROR!';
	echo "<div class='error_message'>There was an issue sending the email. Please try again later.</div>";
}